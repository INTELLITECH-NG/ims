    ...
    public partial class frmUserRegistration : Form
    {
        ...
        public void auto()
        {
            try
            {
                ...
                con.Open();
                string sql = "SELECT MAX(ID+1) FROM user_registration";
                ...
                if (Convert.IsDBNull(cmd.ExecuteScalar()))
                {
                    ...
                    UserID.Text = Convert.ToString("U-" + Num);
                }
                else
                {
        ...
        private void delete_records()
        {
            ...
            try
            {
                ...
                con = new SqlConnection(cs.DBcon);
                con.Open();
                string cq = "delete from User_Registration where ID='" + txtID.Text + "'";
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string cb = "insert into user_registration(UserID,password,contact_no,email,name,date_of_joining,usertype,ID) VALUES (@d1,@d2,@d3,@d4,@d5,@d6,@d7,@d9)";


                cmd = new SqlCommand(cb);
                cmd.Connection = con;
                cmd.Parameters.AddWithValue("@d1", UserID.Text);
                cmd.Parameters.AddWithValue("@d9", txtID.Text);
                cmd.Parameters.AddWithValue("@d7", cmbUsertype.Text);
                cmd.Parameters.AddWithValue("@d2", txtPassword.Text);
                cmd.Parameters.AddWithValue("@d5", txtUserName.Text);
        ...
        private void txtUserName_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "SELECT * FROM user_registration WHERE ID = '" + txtID.Text.Trim() + "'";
                rdr = cmd.ExecuteReader();
                ...
                if (rdr.Read())
                {
                    ...
                    txtUserName.Text = (rdr.GetString(2).Trim());
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string cb = "update user_registration set UserID=@d1 , password=@d2,contact_no=@d3,email=@d4,name=@d5,usertype=@d7 where id=@d8";
        ...
        private void btnGetDetails_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
        frmRegisteredUsersRecord frm = new frmRegisteredUsersRecord();
            frm.Show();
        }
